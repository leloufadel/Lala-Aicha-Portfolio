...
const data = [
  {
    ...
    languages: ['React','Ruby on rails', 'HTML', 'CSS'], 
  ...
  },
  {
    ...
    featuredImage: './logos/e-Budget.png',
    liveLink: 'https://majdalkilany.github.io/JavaScript-capstone-project/dist/',
  ...
  },
  {
    ...
    liveLink: 'https://math-magicians-318i.onrender.com/calculator',
    sourceLink: 'https://github.com/leloufadel/math-magician',
  },
  {
    id: 3,
    title: 'Space Travelers\' Hub',
  ...
  },
  {
    ...
    languages: ['HTML', 'CSS', 'JavaScript'],
    featuredImage: './logos/series-review.png',
    liveLink: 'https://.github.io/Series-Review-Portal/dist/',
    sourceLink: 'https://github.com/anyars-encarta/Series-Review-Portal.git',
  },
  {
    id: 5,
    ...
    languages: ['HTML', 'CSS', 'JavaScript'],
    featuredImage: './logos/leaderboard.png',
    liveLink: 'https://.github.io/Leaderboard-List-App/dist/',
    sourceLink: 'https://github.com//Leaderboard-List-App.git',
  },
  {
    id: 6,
    title: 'Rick and Morty',
    ...
    languages: ['HTML', 'CSS', 'JavaScript'],
    featuredImage: './logos/rick-and-morty.png',
    liveLink: '.github.io/Rick-and-Morty/dist/',
    sourceLink: 'https://github.com/anyars-encarta/Rick-and-Morty.git',
  },
  {
    id: 7,
    ...
    languages: ['React', 'Redux', 'JavaScript'],
    featuredImage: './logos/book-store.png',
    liveLink: '.github.io/book-store/',
    sourceLink: 'https://github.com//book-store.git',
  },
  {
    id: 8,
    title: 'RealTime Search',
    ...
    languages: ['Ruby', 'Rails', 'JavaScript'],
    featuredImage: './logos/realtime-search.png',
    liveLink: 'https://search.onrender.com/',
    sourceLink: 'https://github.com//realtime-search.git',
  },
  {
    id: 9,
    title: 'Image Slider',
    ...
    languages: ['React', 'CSS3', 'Webpack'],
    featuredImage: './logos/image-slider.png',
    liveLink: 'https://.github.io/encarta-image-slider/',
    sourceLink: 'https://github.com//encarta-image-slider.git',
  },
  {
    id: 10,
    title: 'Random Color Generator',
    ...
    languages: ['React', 'CSS3', 'Webpack'],
    featuredImage: './logos/color-generator.png',
    liveLink: 'https://.github.io/encarta-random-color-generator/',
    sourceLink: 'https://github.com//-random-color-generator.git',
  },
  {
    id: 11,
    title: 'Star Rating',
    ...
    languages: ['React', 'CSS3', 'Webpack'],
    featuredImage: './logos/star-rating.png',
    liveLink: 'https://.github.io/encarta-star-rating/',
    sourceLink: 'https://github.com/-rating.git',
  },
  {
    id: 12,
    title: 'Load More Button',
    ...
    languages: ['React', 'CSS3', 'Webpack'],
    featuredImage: './logos/load-more.png',
    liveLink: 'https:/github.io/load-more-button/',
    sourceLink: 'https://github.com//load-more-button.git',
  },
  {
    id: 13,
    title: 'QR Code Generator',
    ...
    languages: ['React', 'CSS3', 'Webpack'],
    featuredImage: './logos/qr-code.png',
    liveLink: 'https://.github.io/qr-code-generator/',
    sourceLink: 'https://github.com//qr-code-generator.git',
  },
  {
    id: 14,
    title: 'Hotel Booking System',
    ...
    featuredImage: './logos/hotel.png',
    liveLink: 'https://hotel-booking-3wof.onrender.com/',
    sourceLink: 'https://github.com//hotel-booking-front-end.git',
  },
  {
    id: 15,
    title: 'Scroll Progress Indicator',
    ...
    languages: ['React', 'CSS3', 'Webpack'],
    featuredImage: './logos/scroll-progress.png',
    liveLink: 'https://.github.io/scroll-progress-indicator/',
    sourceLink: 'https://github.com//scroll-progress-indicator.git',
  },
  {
    id: 16,
    title: 'Tree-view Navigation Menu',
    ...
    languages: ['React', 'CSS3', 'Webpack'],
    featuredImage: './logos/tree-view.png',
    liveLink: 'https://.github.io/tree-view-nav-menu/',
    sourceLink: 'https://github.com//tree-view-nav-menu.git',
  },
  {
    id: 17,
    title: 'Accordion',
    ...
    languages: ['React', 'CSS3', 'Webpack'],
    featuredImage: './logos/accordion.png',
    liveLink: 'https://.github.io/encarta-accordion/',
    sourceLink: 'https://github.com//encarta-accordion.git',
  },
  {
    id: 18,
    title: 'GitHub Profile Finder',
    ...
    languages: ['React', 'CSS3', 'Webpack'],
    featuredImage: './logos/profile-finder.png',
    liveLink: 'https://.github.io/github-profile-finder/',
    sourceLink: 'https://github.com//github-profile-finder.git',
  },
  {
    id: 19,
    title: 'To Do List',
    ...
    languages: ['HTML', 'CSS', 'JavaScript'],
    featuredImage: './logos/Personal-To-Do.png',
    liveLink: 'https://.github.io/Personal-to-Do-App/',
    sourceLink: 'https://github.com//Personal-to-Do-App.git',
  },
  {
    id: 20,
    title: 'Quality Improvement Summit',
    ...
    languages: ['HTML', 'CSS', 'JavaScript'],
    featuredImage: './logos/QI Summit.png',
    liveLink: 'https://github.io/First-Capstone/',
    sourceLink: 'https://github.com//First-Capstone.git',
  },
  {
    id: 21,
    title: 'Personal To Do List',
    ...
    languages: ['HTML', 'CSS', 'JavaScript'],
    featuredImage: './logos/To-Do-List.png',
    liveLink: 'https://.github.io/To-do-list/dist/',
    sourceLink: 'https://github.com//To-do-list.git',
  }
];

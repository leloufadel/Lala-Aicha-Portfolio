...
const data = [
  ...
  },
  {
    ...
    featuredImage: './images/Showmovie.png',
...
const addToModal = (dataId) => {
  ...
  <div class="popup-details">
      ...
      <div class="side-info">
        <p>${selectedData[0].description}</p>
        <div class="out-links">
          <a class="see-live" href=${selectedData[0].liveLink} target="_blank">See Live<img src="./images/See-live.png" alt="live icon"></a>
          <a class="see-source" href=${selectedData[0].sourceLink} target="_blank">See Source<img src="./images/See-source.png" alt="source icon"></a>
        </div>
        </div>
      </div>
      </div>`;
